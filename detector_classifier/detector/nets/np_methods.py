...
def ssd_bboxes_select_layer(predictions_layer,
    ...
    if select_threshold is None or select_threshold == 0:
        ...
        print "===np_methods : sub_predictions.shape = {}".format(sub_predictions.shape)
        idxes = np.where(sub_predictions > select_threshold)# np.where()
        print "===np_methods : indxes ={}".format(idxes)
        classes = idxes[-1]+1
        print "===np_methods : classes ={}".format(classes)
